(function() {
  ...
  const GripHorizontal = createLucideIcon("grip-horizontal", __iconNode$p);
  const __iconNode$o = [
    [
      "path",
      {
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$n);
  const __iconNode$m = [
      ...
      "div",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-black/40 mr-1", children: new Date(note.updatedAt).toLocaleDateString() }),
                  note.isPinned && /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { size: 12, className: "text-red-500 fill-current" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      onClick: (e) => {
                        e.stopPropagation();
                        updateNote(note.id, { isCollapsed: !note.isCollapsed });
                      },
                      className: "p-1 hover:bg-black/10 rounded transition-colors",
                      children: note.isCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 14 })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
          ...
          !note.isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 p-3 overflow-hidden", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                autoFocus: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-8 flex items-center justify-between px-2 border-t border-black/5 text-[10px] text-black/50 flex-shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      showColors && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 bottom-full mb-1 flex gap-1 bg-white p-1 rounded-md shadow-md border border-black/10 z-50", children: COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "고정",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { size: 14 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `p-1 rounded flex items-center gap-1 ${note.status === "done" ? "bg-green-500/10 text-green-600" : note.status === "in-progress" ? "bg-blue-500/10 text-blue-600" : "hover:bg-black/10 text-black/40"}`,
                    title: `Status: ${note.status}`,
                    children: [
                      note.status === "done" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14 }) : note.status === "in-progress" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-bold uppercase", children: note.status })
                    ]
                  }
                )
              ] }),
            ...
            mode === "markup" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  title: "선택 및 수정",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(MousePointer2, { size: 20 })
                }
              ),
