...
도움말: 설정의 토큰값이나 데이터베이스 권한(연결 추가)을 다시 확인해 보세요.`);
  ...
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$M);
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$y);
  const __iconNode$x = [
    ["path", { d: "m9 11-6 6v3h9l3-3", key: "1a3l36" }],
    ["path", { d: "m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4", key: "14a9rk" }]
  ];
  const Highlighter = createLucideIcon("highlighter", __iconNode$x);
  const __iconNode$w = [
  ...
  const Maximize2 = createLucideIcon("maximize-2", __iconNode$r);
  const __iconNode$q = [
  ...
  const Scroll = createLucideIcon("scroll", __iconNode$e);
  const __iconNode$d = [
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { all: "initial", boxSizing: "border-box" }, className: "pointer-events-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `bg-gray-900 shadow-[0_20px_60px_rgba(0,0,0,0.6)] border-2 flex ${isVertical ? "flex-col" : "flex-row"} items-center box-border text-white whitespace-nowrap transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${settings.isCleanView ? "opacity-40 hover:opacity-100" : ""} ${isVisible ? isVertical ? "w-15 max-h-[98vh] h-fit rounded-[22px] p-2 px-1 gap-1" : "w-fit max-w-[98vw] h-15 rounded-[22px] p-1 px-2 gap-1" : "w-13 h-13 rounded-xl p-0 gap-0 border-0"}`,
            style: {
              backgroundColor: isVisible ? "#111827" : "transparent",
              borderColor: isVisible ? accentColor : "transparent",
              boxShadow: isVisible ? `0 20px 60px rgba(0,0,0,0.6), 0 0 25px ${accentColor}33` : "none",
              fontStyle: "normal",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} items-center gap-1.5 transition-all duration-500 ${isVisible ? "opacity-100" : "opacity-0 translate-y-4 pointer-events-none"}`, children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `p-2 rounded-xl transition-all border shrink-0 ${settings.isCleanView ? "bg-white/10" : "bg-white/5 border-white/5 text-gray-400 hover:text-white hover:bg-white/10"}`,
                    ...
                    children: settings.isCleanView ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 18 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 18 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `p-2 rounded-xl transition-all border shrink-0 ${settings.showMiniMap ? "bg-white/10" : "bg-white/5 border-white/5 text-gray-400 hover:text-white hover:bg-white/10"}`,
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Map$1, { size: 18 })
                  }
                ),
                ...
                mode === "markup" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} gap-1 items-center`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} bg-white/5 rounded-xl p-1 border border-white/5 items-center`, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTool("pen"), className: `p-1 rounded-lg transition-all ${currentTool === "pen" ? "text-gray-900" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, style: currentTool === "pen" ? { backgroundColor: accentColor } : {}, title: "펜", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PenTool, { size: 16 }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTool("highlight"), className: `p-1 rounded-lg transition-all ${currentTool === "highlight" ? "text-gray-900" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, style: currentTool === "highlight" ? { backgroundColor: accentColor } : {}, title: "형광펜", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Highlighter, { size: 16 }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTool("eraser"), className: `p-1 rounded-lg transition-all ${currentTool === "eraser" ? "bg-red-500 text-white" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, title: "지우개", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eraser, { size: 16 }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTool("select"), className: `p-1 rounded-lg transition-all ${currentTool === "select" ? "text-gray-900" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, style: currentTool === "select" ? { backgroundColor: accentColor } : {}, title: "선택 및 수정", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MousePointer2, { size: 16 }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} bg-white/5 rounded-xl p-1 border border-white/5 items-center gap-0.5`, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsShapePickerOpen(!isShapePickerOpen), className: `p-1 rounded-lg transition-all ${["rect", "circle", "arrow", "star", "heart", "triangle", "chat", "lightning", "diamond", "pentagon", "hexagon", "cross", "cloud", "banner"].includes(currentTool) ? "text-gray-900" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, style: ["rect", "circle", "arrow", "star", "heart", "triangle", "chat", "lightning", "diamond", "pentagon", "hexagon", "cross", "cloud", "banner"].includes(currentTool) ? { backgroundColor: accentColor } : {}, title: "도형", children: shapes.find((s) => s.id === selectedShape)?.icon || /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 16 }) }),
                      isShapePickerOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-full left-1/2 -translate-x-1/2 mb-4 bg-gray-800 shadow-2xl border border-white/10 rounded-2xl p-2 grid grid-cols-4 gap-1 backdrop-blur-xl z-[100] w-48", children: shapes.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                        setSelectedShape(s.id);
                        setTool(s.id);
                        setIsShapePickerOpen(false);
                      }, className: `p-2 rounded-xl transition-all ${currentTool === s.id ? "text-gray-900" : "text-gray-400 hover:bg-white/10 hover:text-white"}`, style: currentTool === s.id ? { backgroundColor: accentColor } : {}, title: s.label, children: s.icon }, s.id)) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsStickerPickerOpen(!isStickerPickerOpen), className: `p-1 rounded-lg transition-all ${currentTool === "sticker" ? "text-gray-900" : "text-gray-400 hover:bg-white/5 hover:text-white"}`, style: currentTool === "sticker" ? { backgroundColor: accentColor } : {}, title: "스티커", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base leading-none", children: currentTool === "sticker" ? selectedSticker : /* @__PURE__ */ jsxRuntimeExports.jsx(Smile, { size: 16 }) }) }),
                      isStickerPickerOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-full left-1/2 -translate-x-1/2 mb-4 bg-gray-800 shadow-2xl border border-white/10 rounded-2xl p-3 grid grid-cols-4 gap-2 w-48 backdrop-blur-xl z-[100]", children: stickers.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                        setSelectedSticker(s);
                        setTool("sticker");
                        setIsStickerPickerOpen(false);
                        window.__pagepost_selected_sticker = s;
                      }, className: "text-2xl hover:bg-white/10 p-2 rounded-xl transition-all hover:scale-125", children: s }, s)) })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} bg-white/5 rounded-xl p-1 border border-white/5 items-center gap-1`, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => undoMarkup(), className: "p-1 text-gray-400 hover:text-white rounded-lg hover:bg-white/10 transition-all shrink-0", title: "실행 취소 (Undo)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Undo2, { size: 16 }) }),
                    !["eraser", "select"].includes(currentTool) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} items-center gap-0.5 bg-white/10 rounded-lg p-0.5 border border-white/5 shadow-inner shrink-0`, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                      ...
                      }, className: "w-6 h-6 flex items-center justify-center text-gray-400 hover:text-white rounded-md hover:bg-white/10 transition-all", title: "두께 감소", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 12 }) }),
                      ...
                      }, className: "w-6 h-6 flex items-center justify-center text-gray-400 hover:text-white rounded-md hover:bg-white/10 transition-all", title: "두께 증가", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold", children: "+" }) })
                    ] }),
                    !["eraser", "select"].includes(currentTool) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex ${isVertical ? "flex-col" : "flex-row"} items-center gap-0.5 bg-white/10 rounded-lg p-0.5 border border-white/5 shadow-inner shrink-0`, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpacity(Math.max(0.1, settings.markupOpacity - 0.1)), className: "w-6 h-6 flex items-center justify-center text-gray-400 hover:text-white rounded-md hover:bg-white/10 transition-all", title: "투명도 감소", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 12 }) }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpacity(Math.min(1, settings.markupOpacity + 0.1)), className: "w-6 h-6 flex items-center justify-center text-gray-400 hover:text-white rounded-md hover:bg-white/10 transition-all", title: "투명도 증가", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold", children: "+" }) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center px-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-8 h-8 rounded-full border flex items-center justify-center overflow-hidden transition-transform hover:scale-110 shrink-0", style: { backgroundColor: currentColor, borderColor: `${accentColor}80` }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Palette, { size: 14, className: "text-white mix-blend-difference pointer-events-none" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "color", value: currentColor, onChange: (e) => setColor(e.target.value), className: "absolute inset-0 w-full h-full opacity-0 cursor-pointer", title: "마크업 색상" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                      if (confirm("이 페이지의 모든 마킹을 지우시겠습니까?")) clearAllMarkups();
                    }, className: "p-1 text-gray-400 hover:text-red-400 rounded-lg hover:bg-red-500/10 transition-all shrink-0", title: "모두 지우기", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 16 }) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 flex items-center justify-center transition-all duration-500 ${!isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75 pointer-events-none"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-full flex items-center justify-center group/collapsed overflow-visible", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer p-0",
                    title: "Open Tools",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
  ...
  const CaptureLayer = () => {
    ...
    const [captureType, setCaptureType] = reactExports.useState("area");
    ...
    const handleVisibleCapture = async () => {
      if (!isExtensionValid2() || isCapturing) return;
      const captureRoot = containerRef.current;
      if (captureRoot) {
        captureRoot.style.visibility = "hidden";
        captureRoot.style.opacity = "0";
      ...
      try {
        ...
        if (error?.message?.includes("context invalidated") || !isExtensionValid2()) {
          alert("확장 프로그램이 업데이트되었습니다.\n페이지를 새로고침한 후 다시 시도해주세요.");
        } else {
          alert("현재 화면 캡쳐에 실패했습니다.");
        }
      } finally {
        if (isExtensionValid2() && captureRoot) {
          captureRoot.style.visibility = "visible";
          captureRoot.style.opacity = "1";
        }
      }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          !capturedImage && !isCapturing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-6 animate-in slide-in-from-top duration-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900/90 backdrop-blur-xl border border-white/20 p-2 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MousePointer2, { size: 18 }),
                    "영역 선택"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 bg-white/10 mx-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex items-center gap-2 px-4 py-2 rounded-2xl transition-all text-gray-400 hover:text-white hover:bg-white/10`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Scroll, { size: 18 }),
                    "스크롤 캡쳐"
                  ]
                }
              ),
            ...
            captureType === "area" && !isSelecting && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-brand-primary/20 backdrop-blur-md border border-brand-primary/30 text-brand-primary px-4 py-2 rounded-full text-sm font-bold animate-pulse", children: "화면을 드래그하여 캡쳐할 영역을 선택하세요" })
          ] }),
          isCapturing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center gap-8 z-[500]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 80, className: "text-brand-primary animate-spin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex items-center justify-center font-black text-white text-xl", children: [
                Math.round(captureProgress),
                "%"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white", children: "스크롤 캡쳐 진행 중..." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: "데이터를 수집하고 이미지를 합성하고 있습니다." })
            ] })
          ] }),
