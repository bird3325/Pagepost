(function() {
  ...
  const Diamond = createLucideIcon("diamond", __iconNode$s);
  const __iconNode$r = [
  ...
  const GripHorizontal = createLucideIcon("grip-horizontal", __iconNode$n);
  const __iconNode$m = [
    [
      "path",
      {
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$l);
  const __iconNode$k = [
    ["path", { d: "m9 11-6 6v3h9l3-3", key: "1a3l36" }],
    ["path", { d: "m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4", key: "14a9rk" }]
  ];
  const Highlighter = createLucideIcon("highlighter", __iconNode$k);
  const __iconNode$j = [
