(function() {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "완료 처리",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14 })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1", children: new Date(note.updatedAt).toLocaleDateString() }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
  ...
  const FloatingToolbar = () => {
    ...
    const [isColorPickerOpen, setIsColorPickerOpen] = reactExports.useState(false);
    React.useEffect(() => {
      if (isExpanded) {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Palette, { size: 20 })
                }
              ),
              isColorPickerOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-full right-0 mb-4 bg-gray-800 shadow-2xl border border-white/10 rounded-xl p-2.5 grid grid-cols-4 gap-2 backdrop-blur-xl", children: colors.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => {
