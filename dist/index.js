    ...
    chrome.storage.onChanged.addListener((changes, areaName) => {
      if (areaName === "local") {
        ...
        if (changes[SETTINGS_KEY]) {
          ...
          if (newValue) {
            console.log("PagePost: Settings updated - showToolbar:", newValue.showToolbar);
            set((state) => ({
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "w-[320px] h-[480px] bg-gray-50 flex flex-col font-sans overflow-hidden",
      ...
      children: [
        ...
        isSearchOpen && !isSettingsOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 bg-white border-b border-gray-100 flex items-center gap-2 animate-in slide-in-from-top duration-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14, className: "absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        isSettingsOpen ? (
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-6 bg-white animate-in fade-in duration-200", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-gray-700 uppercase", children: "플로팅 툴바 표시" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 italic font-medium", children: "웹페이지 하단 툴바 노출 여부" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-[10px] text-gray-400 font-sans", children: "데이터를 삭제하면 모든 웹페이지의 메모가 영구적으로 지워집니다." })
            ] })
          ] })
        ) : (
          /* Note List */
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-2", children: notes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center text-gray-400 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StickyNote, { size: 32, strokeWidth: 1.5, className: "opacity-50" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: searchQuery ? "검색 결과가 없습니다." : "현재 상태에 메모가 없습니다." })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: notes.map((note) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-brand-primary truncate max-w-[120px]", children: note.domain }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-sm text-gray-800 line-clamp-3 leading-relaxed",
                    style: {
                    ...
                    children: note.content || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 italic", children: "내용 없음" })
                  }
                ),
                note.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex flex-wrap gap-1", children: note.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] px-1.5 py-0.5 bg-gray-100 text-gray-500 rounded", children: [
                  "#",
                  tag
                ] }, tag)) })
              ]
